...
<div class="weui-cells" id="celllist">
    <c:forEach items="${mzsches}" var="mzsches" varStatus="i">
        <a class="weui-cell">
            <div class="weui-cell__hd"></div>
            <div class="weui-cell__bd">
                <p> ${mzsches.date} &nbsp ${mzsches.weekday} &nbsp ${mzsches.noon}</p></div>
            <div class="weui-cell__ft"><p>${mzsches.depname}</p></div>
        </a>
    </c:forEach>
</div>
</body>
